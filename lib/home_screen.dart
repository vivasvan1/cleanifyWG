...
import 'main.dart' show ReceivedNotification;
import 'package:device_info/device_info.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
...
Stream<QuerySnapshot<Map<String, dynamic>>> mytasks =
    firestore.collection('tasks').snapshots();

// getTasks() {
//   mytasks.get().then((QuerySnapshot querySnapshot) {
          ...
          children: [
            ...
            StreamBuilder<QuerySnapshot>(
                ...
                builder: (BuildContext context,
                  ...
                  Map taskmap = new Map<DateTime, List<Event>>();
